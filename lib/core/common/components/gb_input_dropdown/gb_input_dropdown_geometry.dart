...
class GbInputDropdownGeometry {
  ...
  static const double helpIconToDropdownSpacing = GlobusSpacing.spacing3;
  ...
  //  MODAL GEOMETRY
  // ===========================================================================
  static const double modalAbsoluteMaxHeight = 844.0;
  static const double modalPaddingOuter = GlobusSpacing.spacing2;
  static const double modalBorderRadius = GlobusRadius.lg;

  static const double headerPaddingHorizontal = GlobusSpacing.spacing4;
  static const double headerPaddingVertical = GlobusSpacing.spacing1;
  static const double titleBottomPadding = GlobusSpacing.spacing4;

  static const double dragHandleWidth = 32.0;
  static const double dragHandleHeight = 4.0;
  static const double dragHandleTopMargin = GlobusSpacing.spacing2;
  ...
  static const double itemContentPadding = GlobusSpacing.spacing2;
